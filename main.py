...
for i in range(3):
     mat_khau = input("Mời Bạn Nhập Đúng Mật Khẩu: ")
     so_lan = 3
     count = 0
     if (mat_khau == password):
      ...
      print("bạn đã nhập sai mật khẩu số lần còn lại ",so_lan - i)
      continue
      while mat_khau != password:
        count +=1
        if count > 3:
          print("Bạn Đã Nhập Hết Số Lần rồi")
          exit()
...
""")
		...
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"TháiTool"+Color.LB+" @ "+Color.LG+"DDoS"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
